...
insert into teammates (name, email, is_admin, active)
...
grant select, insert, update, delete on teammates to anon, authenticated;
...
grant select, insert, update, delete on audit_log to anon, authenticated;
